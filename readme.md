...
* Folder: [examples](./examples) contains examples of using the actions
  ...
  * [example 3 - regression double-bootstrap parameter estimates.sas](./examples/example%203%20-%20regression%20double%20-%20bootstrap%20parameter%20estimates.sas)
  ...
  * [example 7 - residual bootstrapping.sas](./examples/example%207%20-%20residual%20bootstrapping.sas)
